...
module.exports = (function () {
  ...
  /**
   * Ensure object path is a small utility function for use with JSON pointers the ensures a particular pointer path
  ...
  function processKeyValuePairsInConsul(configRequest, consulClient, errors, finalConfig) {
    var requestedKeys = configRequest.keys,
        ...
        foundKeyIdx,
        resultPtr;
    if (consulClient !== undefined && requestedKeys) {
      consulClient.kv.get({
